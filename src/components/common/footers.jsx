                                        ...
                                        <div className="footer-links">
                                            ...
                                            <div className="contact-box">
                                                ...
                                                <div className="address">
                                                    Office no. 108, 3rd Floor,<br />
                                                    5 Star Business Centre Rasis Building,<br />
                                        ...
                                        <div className="footer-links">
                                            ...
                                            <div className="category-list">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <Link to={`${process.env.PUBLIC_URL}/faq`} onClick={this.scrollTop}>FAQs</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="copyrigth-area">
                                    <p>Copyright 2022 Travel Finder</p>
                                </div>
                            </div>
                        </div>
                    </div>
