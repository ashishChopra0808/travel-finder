                    ...
                    <div className="row">
                            ...
                            <div className="topbar-contact">
                                <ul>
                                    <li>
                                        ...
                                        <a href="tel:+971525145041">+971 52 514 5041</a>
                                    </li>

                                    <li>
                                        <i className="bx bxs-envelope" />
                                        <a href="mailto:info@travelfinder.ae">info@travelfinder.ae</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6 col-xs-6 col-6">
                            <div className="topbar-social">
                                <ul>
                                    <li>
                                        <a href="https://instagram.com/travelfinderae?igshid=YmMyMTA2M2Y=" target="_blank" rel="noreferrer">
                                            <i className="bx bxl-instagram" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/TravelfinderAE/" target="_blank" rel="noreferrer">
                                            <i className="bx bxl-facebook" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://twitter.com/travelfinderae" target="_blank" rel="noreferrer">
                            ...
                            <div className="col-lg-2 col-md-12 col-sm-12 col-xs-12">
                                <div className="navbar-wrap">
                                    <div className="logo d-flex justify-content-between">
                                        <Link to={`${process.env.PUBLIC_URL}/`} className="navbar-brand" onClick={this.scrollTop}>
                                            {/*<img src={logoMain} alt="" />*/}
                                            <img src={secondLogo} alt="" width="100" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                <nav className="main-nav">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <NavLink activeClassName="active" to={`${process.env.PUBLIC_URL}/discover-uae`} onClick={this.scrollTop} >Discover UAE</NavLink>
                                        </li>
                                        <li>
                                            <NavLink activeClassName="active" to={`${process.env.PUBLIC_URL}/package-sidebar`} onClick={this.scrollTop} >Visa Valet</NavLink>
                                        </li>
                                        <li>
                                            <NavLink  activeClassName="active" to={`${process.env.PUBLIC_URL}/faq`} onClick={this.scrollTop} >FAQs</NavLink >
                                        </li>
                                        <li>
                                    ...
                                    <div className="sidebar-contact">
                                        <ul>
                                            <li className="sidebar-single-contact"><i className="bx bxs-phone" />
                                                <Link to={`tel:+971525145041`} >+971 52 514 5041</Link>
                                            </li>
                                            <li className="sidebar-single-contact"><i className="bx bxs-envelope" />
                                                <Link to={`mailto:info@travelfinder.ae`} >info@travelfinder.ae</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
